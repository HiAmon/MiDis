...
var provinceList = [
{name:'北京', cityList:[		   
{name:'市辖区', areaList:['东城区','西城区','朝阳区','丰台区','石景山区','海淀区','门头沟区','房山区','通州区','顺义区','昌平区','大兴区','怀柔区','平谷区']},		   
...
{name:'台湾省', cityList:[		   
{name:'台北市', areaList:['台北市']},
{name:'高雄市', areaList:['高雄市']},
{name:'台南市', areaList:['台南市']},
{name:'台中市', areaList:['台中市']},
{name:'金门县', areaList:['金门县']},
{name:'南投县', areaList:['南投县']}
]},
{name:'香港特别行政区', cityList:[		   
{name:'香港岛', areaList:['香港岛']},
{name:'九龙', areaList:['九龙']},
{name:'新界', areaList:['新界']}
]},
{name:'澳门特别行政区', cityList:[		   
{name:'澳门半岛', areaList:['澳门半岛']},
{name:'离岛', areaList:['离岛']}
]}
];
			...
			$("#province").change(function(){
				...
				if(selectedProvince == ""){
					...
					for(var i = 0;i<provinceList.length;i++){
						if(selectedProvince == provinceList[i].name){
							var cities = provinceList[i].cityList;
							showCity(cities);
							break;
						}
					}
			...
			//选择市之后，根据市的值遍历追加到区的下拉框中
			$("#city").change(function(){
				var province = $("#province").val();
				var selectedCity = $(this).val();  //当前市框的值
				for(var i = 0;i<provinceList.length;i++){
					if(provinceList[i].name == province){
						var cities = provinceList[i].cityList;
						for(var j = 0;j<cities.length;j++){
							if(selectedCity == cities[j].name){
								var areas = cities[j].areaList;
								showArea(areas);
							}
						}
					}	
